...
export default function DashboardMobileSidebar({ appName }: { appName: string }) {
  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-300 bg-white text-slate-800 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"
      ...
      {open && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 flex h-dvh w-[260px] min-h-0 flex-col border-r border-slate-300 bg-slate-100 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
            <div className="flex h-10 shrink-0 items-center justify-end border-b border-slate-300 px-2 dark:border-slate-800">
              <button
                type="button"
                onClick={() => setOpen(false)}
                className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-300 bg-white text-slate-800 transition hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700"
