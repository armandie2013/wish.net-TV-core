...
export default function PlanGridEditor({
  ...
  return (
    <>
        ...
        <div>
          ...
          <div className="flex gap-2">
            ...
            <button
              type="button"
              onClick={applyCantidad}
              className="inline-flex shrink-0 items-center justify-center rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-semibold text-blue-800 transition hover:bg-blue-100 dark:border-cyan-500/20 dark:bg-cyan-500/10 dark:text-cyan-400 dark:hover:bg-cyan-500/20"
            >
              Aplicar
            </button>
          </div>
          ...
          <p className="mt-1 text-xs text-slate-500 dark:text-slate-500">
            Escribí la cantidad y presioná{" "}
            <span className="font-semibold text-slate-700 dark:text-slate-400">
              Aplicar
            </span>
            . Si reducís la grilla, el sistema te pedirá confirmación.
          </p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-300 bg-slate-50/70 dark:border-slate-800 dark:bg-slate-950/60">
        <div className="border-b border-slate-300 px-4 py-4 dark:border-slate-800">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
            <thead className="bg-slate-100 text-left text-[11px] uppercase tracking-[0.18em] text-slate-500 dark:bg-slate-900/95">
              <tr className="border-b border-slate-300 dark:border-slate-800">
                ...
                <th className="px-4 py-3 font-semibold">Nombre visible</th>
                <th className="px-4 py-3 font-semibold">Categoría</th>
                <th className="px-4 py-3 text-center font-semibold">Hab.</th>
              </tr>
            </thead>
            ...
            <tbody className="text-slate-700 dark:text-slate-300">
              {grid.map((item, index) => {
                ...
                return (
                  <tr
                    key={index}
                    className="border-b border-slate-200 align-top transition hover:bg-slate-100/70 last:border-b-0 dark:border-slate-800/80 dark:hover:bg-slate-950/30"
                  >
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="w-[220px] rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-blue-400 focus:ring-4 focus:ring-blue-100 dark:border-slate-800 dark:bg-slate-950/80 dark:text-slate-100 dark:focus:border-cyan-500/50 dark:focus:ring-cyan-500/10"
                        placeholder="Nombre visible"
                      />
                    </td>
