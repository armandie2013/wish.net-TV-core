...
export function FormShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex h-full min-h-0 flex-col overflow-y-auto overflow-x-hidden rounded-xl border border-slate-300 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/60">
      {children}
    </div>
  );
}
  ...
  return (
    <div className="shrink-0 border-b border-slate-200 px-3 py-3 dark:border-slate-800 2xl:py-4">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <Link
          href={backHref}
          className="inline-flex h-8 items-center justify-center rounded-lg border border-slate-300 bg-slate-100 px-3 text-[11px] font-medium text-slate-800 transition hover:bg-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700 2xl:h-9 2xl:px-4 2xl:text-[12px]"
        >
          {backLabel}
        </Link>
      </div>
...
export function FormCard({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/60 dark:shadow-none">
      <div className="border-b border-slate-200 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.14em] text-slate-600 dark:border-slate-800 dark:text-slate-300 2xl:py-2 2xl:text-[11px]">
        {title}
      </div>

      <div className="p-2.5 2xl:p-3">{children}</div>
    </div>
  );
}
...
export function FormGrid({
  ...
  return (
    <div className={cn("grid gap-2.5 2xl:gap-3", columns)}>{children}</div>
  );
}
  ...
  return (
    <div>
      ...
      <input
        ...
        className={
          readOnly
            ? "h-8 w-full cursor-not-allowed rounded-lg border border-slate-300 bg-slate-100 px-3 text-[12px] text-slate-500 outline-none dark:border-slate-800 dark:bg-slate-950/40 dark:text-slate-500 2xl:h-9"
            : "h-8 w-full rounded-lg border border-slate-300 bg-white px-3 text-[12px] text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:border-slate-800 dark:bg-slate-950/60 dark:text-white dark:placeholder:text-slate-500 dark:focus:border-cyan-500/50 dark:focus:ring-cyan-500/10 2xl:h-9"
        }
      />
  ...
  return (
    <div>
      ...
      <select
        ...
        defaultValue={defaultValue ?? ""}
        required={required}
        className="h-8 w-full rounded-lg border border-slate-300 bg-white px-3 text-[12px] text-slate-900 outline-none transition focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:border-slate-800 dark:bg-slate-950/60 dark:text-white dark:focus:border-cyan-500/50 dark:focus:ring-cyan-500/10 2xl:h-9"
      >
        {options.map((option) => (
          <option key={`${name}-${option.value}`} value={option.value}>
            {option.label}
  ...
  return (
    <div>
      ...
      <textarea
        ...
        required={required}
        maxLength={maxLength}
        className="w-full resize-none rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-[12px] text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:border-slate-800 dark:bg-slate-950/60 dark:text-white dark:placeholder:text-slate-500 dark:focus:border-cyan-500/50 dark:focus:ring-cyan-500/10 2xl:py-2"
      />
