  ...
  return (
    <section className="space-y-6">
      <div className="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900/80">
        ...
        {/* SUCCESS BLOCKS */}
        {success === "user-created" && createdEmail && tempPassword && (
          <div className="mx-6 mt-6 rounded-2xl border border-emerald-300 bg-emerald-100 px-4 py-4 text-sm text-emerald-800 dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-300">
        ...
        {success === "password-reset" && createdEmail && tempPassword && (
          <div className="mx-6 mt-6 rounded-2xl border border-yellow-300 bg-yellow-100 px-4 py-4 text-sm text-yellow-800 dark:border-yellow-500/20 dark:bg-yellow-500/10 dark:text-yellow-300">
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                          href={`/users/${user._id}/password`}
                          className="rounded-xl border border-yellow-300 bg-yellow-100 px-3 py-2 text-xs font-semibold text-yellow-800 transition hover:bg-yellow-200 dark:border-yellow-500/20 dark:bg-yellow-500/10 dark:text-yellow-300 dark:hover:bg-yellow-500/20"
                        >
                          Restablecer
                        </Link>
