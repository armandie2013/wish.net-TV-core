          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">
                Administrá servidores origin y edge para la entrega de
                contenido.
              </p>
            </div>
              ...
              {nodes.length === 0 ? (
                ...
                nodes.map((node) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="rounded-full border border-blue-200 bg-blue-50 px-2 py-1 text-[10px] font-semibold uppercase tracking-wide text-blue-800 dark:border-cyan-500/20 dark:bg-cyan-500/10 dark:text-cyan-400">
                        {node.tipo}
                      </span>
                    </td>
