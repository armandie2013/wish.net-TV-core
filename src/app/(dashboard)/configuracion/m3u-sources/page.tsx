  ...
  return (
    <section className="space-y-6">
      <div className="overflow-hidden rounded-2xl border border-slate-300 bg-white shadow-xl dark:border-slate-800 dark:bg-slate-900/80">
        ...
        {success === "import-completed" && (
          <div className="mx-6 mt-6 rounded-2xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-800 dark:border-cyan-500/20 dark:bg-cyan-500/10 dark:text-cyan-300">
            Importación completada. Detectados: <strong>{detected}</strong> ·
            Nuevos: <strong>{created}</strong> · Actualizados:{" "}
            <strong>{updated}</strong>
          </div>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-wrap gap-2">
                        ...
                        >
                          <button
                            type="submit"
                            className="rounded-xl border border-blue-200 bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-800 transition hover:bg-blue-100 dark:border-cyan-500/20 dark:bg-cyan-500/10 dark:text-cyan-300 dark:hover:bg-cyan-500/20"
                          >
                            Importar ahora
                          </button>
                        </form>
