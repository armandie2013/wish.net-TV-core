...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <Card title="USUARIOS ONLINE" value={stats?.onlineUsers ?? "-"} color="cyan" />
        <Card title="USUARIOS ACTIVOS" value={stats?.activeUsers ?? "-"} color="emerald" />
        <Card title="USUARIOS SUSPENDIDOS" value={stats?.suspendedUsers ?? "-"} color="red" />
        <Card title="USUARIOS TOTALES" value={stats?.totalUsers ?? "-"} />
      </div>
